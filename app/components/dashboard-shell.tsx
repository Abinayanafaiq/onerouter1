      ...
      <div className="relative z-10 lg:pl-60">
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-white/[0.06] bg-background/80 px-4 backdrop-blur-xl sm:px-6">
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <span className="text-[13px] font-medium text-foreground/90">{t("workspace")}</span>
            <span className="rounded-md border border-white/10 bg-white/[0.03] px-1.5 py-0.5 text-[10px] text-muted-foreground">{t("productionBadge")}</span>
          </div>
